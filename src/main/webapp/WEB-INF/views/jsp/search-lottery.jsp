				...
				<div class="flex result">
					...
					<c:if test="${rl==null}">
						<div class="notice">
							...
							<p>Kết quả xổ số ${province} mở thưởng ngày ${date} hiện chưa
								có trên hệ thống.</p>
						</div>
					</c:if>
					<div class="flex result-search">
						<c:if test="${listPrize!=null}">
							<img
								src="<c:url value="/resources/assets/imgs/congratulation.png"/>"
								alt="congratulation">
							<div class="flex congratulation">
								<h5>Chúc mừng</h5>
								<p>Bạn đã trúng ${listPrize}</p>
								<p>Dãy số trúng thưởng là: ${codePrize}</p>
							</div>
						</c:if>
						<c:if test="${listPrize==null && rl!=null}">
							<img src="<c:url value="/resources/assets/imgs/good-luck.jpg"/>"
								alt="good-luck">
							<div class="flex good-luck">
								<h5>Chúc bạn may mắn lần sau</h5>
							</div>
						</c:if>
					</div>
					<div class="notice">
						<h5>Những qui định chung:</h5>
						<p>-Vé số trúng là vé có các số cuối trùng với các con số trên
							bảng kết quả theo thứ tự hàng, vé sai một số so với giải Đặc Biệt
							(theo cơ cấu giải Khuyến Khích hay Đặc Biệt Phụ đối với vé số
							Miền Nam và Miền Trung), vé có 2 số cuối trùng với 2 số cuối giải
							Đặc Biệt (đối với vé số Miền Bắc)</p>
						<p>-Vé số trúng phải còn nguyên hình, nguyên số, không rách
							rời và không cạo sửa.</p>
						<p>-Vé số trúng được lãnh thưởng 1 lần bằng tiền mặt hoặc
							chuyển khoản trong thời hạn trả thưởng qui định.</p>
						<p>-Vé số trúng nhiều giải được lãnh đủ giá trị các giải.</p>
						<p>-Các giải có tổng giá trị trên 10 triệu đồng phải đóng thuế
							thu nhập cá nhân, các Công Ty Xổ Số khấu trừ và nộp vào ngân sách
							nhà nước khi trả thưởng.</p>
					</div>
				</div>
			</div>
		...
		<footer class="footer container-fluid pt-1">
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="flex items-footer">
						<h5>Kết quả xổ số</h5>
						<a href="./home/MB">Kết quả xổ số Miền Bắc</a> <a href="./home/MT">Kết
							quả xổ số Miền Trung</a> <a href="./home/MN">Kết quả xổ số Miền
							Nam</a>
					</div>
				</div>
			</div>
